...
namespace ECommerceProject.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Symbol,Name")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Symbol,Name")] Currency currency)
        {
            if (id != currency.Symbol)
            {
                return NotFound();
            }
        ...
        {
          return (_context.Currencies?.Any(e => e.Symbol == id)).GetValueOrDefault();
        }
    }
}
